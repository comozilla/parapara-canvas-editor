+function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    //onAddFrame(document.getElementById("menu-thumbnails").getElementsByTagName("li")[0]);
  });
  function onAddFrame(li) {
    console.log("**")
    li.addEventListener("mousedown", function() {
      li.getElementsById("").style.display = "block";
    });
    li.addEventListener("mouseup", function() {
      li.getElementsByTagName("div").style.display = "none";
    });
  }
